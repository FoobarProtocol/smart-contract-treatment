...
The dataset will be available at 🤗 [Hugging Face](https://huggingface.co/datasets/foobarprotocol/smart_contracts).

## Metrics

| Component | Size | Num rows | LoC[^1] |
| --------- |:----:| -------:| -------:|
| [Raw](https://huggingface.co/datasets/foobarprotocol/smart_contracts/tree/main/data/raw)| 8.80 GiB | 2217692 | 839665295 |
| [Flattened](https://huggingface.co/datasets/foobarprotocol/smart_contracts/tree/main/data/flattened) | 1.16 GiB | 136969 | 97529473 |
| [Inflated](https://huggingface.co/datasets/foobarprotocol/smart_contracts/tree/main/data/inflated) | 0.76 GiB | 186397 | 53843305 |
| [Parsed](https://huggingface.co/datasets/foobarprotocol/smart_contracts/tree/main/data/parsed) | 4.44 GiB | 4434014 | 29965185 |
...
### Raw
The raw dataset contains mostly the raw data from Etherscan, downloaded with the [smart-contract-downlader](https://github.com/foobarprotocol/smart-contract-downloader) tool. It normalizes all different contract formats (JSON, multi-file, etc.) to a flattened source code structure.
...
This repository is licensed under the [MIT License](https://github.com/foobarprotocol/verified-smart-contracts/blob/main/LICENSE).
